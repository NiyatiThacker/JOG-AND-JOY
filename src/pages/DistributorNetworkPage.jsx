  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] pt-16 pb-24 font-sans overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Header Section */}
        <div className="text-center max-w-4xl mx-auto mb-12 relative bg-white/40 border border-slate-100/80 rounded-[2.5rem] py-16 px-6 sm:px-12 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">

          {/* LiquidEther background wrapper */}
          <div className="absolute inset-0 z-0 rounded-[2.5rem] overflow-hidden pointer-events-auto">
            <LiquidEther
              colors={['#EF4A45', '#AEE6FF', '#FFD800']}
              mouseForce={18}
              cursorSize={85}
              autoDemo={true}
              autoSpeed={0.4}
          ...
          <div className="hidden lg:flex absolute -left-10 top-24 text-slate-800 -rotate-12 flex-col items-end z-10 pointer-events-none">
          ...
          <div className="hidden lg:flex absolute -right-4 top-16 text-slate-800 rotate-12 flex-col items-center z-10 pointer-events-none">
          ...
          <div className="relative z-10 pointer-events-none select-none flex flex-col items-center">
            <div className="inline-flex items-center gap-2 px-5 py-1.5 rounded-full bg-[#FFE7C8]/80 text-[#D88941] font-bold text-sm mb-8 shadow-xs">
              Join over 500+ happy distributors
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-[4.2rem] font-bold text-black tracking-tight leading-[1.05] mb-8">
