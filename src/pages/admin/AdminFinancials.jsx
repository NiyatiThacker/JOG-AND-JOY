                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-border">
                    {financials.transactions.length === 0 && (
                      <tr><td colSpan="4" className="px-4 py-8 text-center text-text-secondary">No transactions found</td></tr>
                    )}
                    {financials.transactions.map(t => (
                      <tr key={t.id} className="hover:bg-zinc-50">
                        <td className="px-4 py-3 text-text-secondary">{formatDate(t.date)}</td>
                        <td className="px-4 py-3 font-bold text-primary-dark">#{t.orderNumber}</td>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-border">
                    <tr className="hover:bg-zinc-50">
                      <td className="px-4 py-3 font-bold text-primary-dark">Default Region (Store)</td>
            ...
            <div className="p-6">
              ...
              <div className="bg-white border border-border rounded-xl overflow-hidden">
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-border">
                    <tr className="hover:bg-zinc-50">
                      <td className="px-4 py-3 font-bold text-primary-dark">Payment Gateway</td>
                      <td className="px-4 py-3 text-text-secondary">2.5% per transaction</td>
