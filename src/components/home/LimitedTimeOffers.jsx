      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center text-center lg:text-left">
          ...
          <div className="lg:col-span-7 space-y-4">
            <span className="px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-md text-white text-xs font-black uppercase tracking-wider inline-flex items-center gap-1.5 border border-white/30">
              <Flame className="w-4 h-4 text-amber-300 fill-amber-300 animate-pulse" /> Flash Sale Ending Soon!
            </span>
            ...
            <p className="text-sm sm:text-base font-semibold text-white/90 max-w-xl">
              Use code <strong className="bg-white text-[#EF4A45] px-2 py-0.5 rounded-md font-black">KIDS20</strong> at checkout for extra discounts & free delivery on orders above ₹999.
            </p>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-end space-y-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-center bg-white/20 backdrop-blur-md p-3.5 rounded-2xl min-w-[70px] border border-white/30">
            ...
            <Link
              ...
              className="px-8 py-3.5 rounded-full bg-white text-[#EF4A45] hover:bg-[#FFD800] hover:text-slate-900 font-extrabold text-sm shadow-xl hover:scale-105 transition-all flex items-center gap-2 group"
            >
