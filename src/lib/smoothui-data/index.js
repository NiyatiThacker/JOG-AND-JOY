...
export const testimonialsData = peopleData.filter((person) => person.stars && person.content);
 ...
 */
function processFullUrl(imagePath, transformations) {
 ...
 */
function buildLocalPathUrl(imagePath, transformations) {
  const endpoint =
 ...
 */
export function getImageKitUrl(imagePath, options) {
 ...
 */
export function getAvatarUrl(avatar, size = 40) {
...
export function getTeamMembers(count = 4, includeTestimonials = false) {
...
export function getTestimonials(count = 4) {
...
export function getPeopleWithTestimonials() {
