      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 xl:px-8 pt-8">
        ...
        <div className="w-full max-w-6xl mx-auto bg-[#A7DEB9] rounded-4xl overflow-hidden flex flex-col md:flex-row items-center justify-between mb-4 shadow-sm min-h-[320px]">
          <div className="p-8 md:p-16 max-w-xl text-left">
            ...
            <p className="text-slate-800 font-medium text-sm md:text-base opacity-80 leading-relaxed max-w-md">
              Estock sets encourage young adults to pursue their passion for building, engineering, STEM and robotics in a creative way.
            </p>
          </div>
          <div className="hidden md:block w-full max-w-md p-8 pt-0 md:pt-8 relative">
            <img
              src="https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?q=80&w=800&auto=format&fit=crop"
              alt="Toy Train"
              className="w-full object-contain rounded-2xl mix-blend-multiply opacity-90 -translate-x-4"
            />
          </div>
        </div>
