      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {REVIEWS.map((review) => (
            <div
              key={review.id}
              className="kids-card p-6 border border-slate-100 flex flex-col justify-between space-y-4 bg-white"
            >
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 font-extrabold">Verified Buyer • {review.product}</p>
                </div>
              </div>
            </div>
          ))}
